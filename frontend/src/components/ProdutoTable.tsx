...
import { ChevronLeft, ChevronRight, PackageSearch, Plus, RefreshCw, Search } from 'lucide-react'
...
interface ProdutoTableProps {
  ...
  onAdicionarAoCarrinho: (produto: ProdutoResponseDTO) => void
}

export function ProdutoTable({ produtos, carregando, erro, onTentarNovamente, onAdicionarAoCarrinho }: ProdutoTableProps) {
                ...
                return (
                  <TableRow key={produto.id}>
                    ...
                    <TableCell className="text-right">
                      <Button size="sm" disabled={esgotado} onClick={() => onAdicionarAoCarrinho(produto)}>
                        <Plus /> Adicionar
                      </Button>
                    </TableCell>
                  </TableRow>
